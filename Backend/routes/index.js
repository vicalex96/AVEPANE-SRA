...
const router = Router();
const { getAlumnos,getAlumnosExt, getAlumno, createAlumno, updateAlumno, deleteAlumno, getinscripciones, getinscripcion,getdocumento_faltantes, getdocumentos,insertDocumento,  getTelefonos,insertTelefono, deleteTelefono, getCarreras,getMaterias, getMateriasAlumno,insertMateria,updateMateria, getPeriodos, insertInscripcion,updateInscripcion,insertarDocumentoIns, eliminarDocumentoIns}= require('../controllers/funciones.controller.js')

router.get('/lista-periodos', getPeriodos);
